...
class TFracUnitTest {
	...
	fun initTest() {
		...
		val expect = true
		assertEquals(expect, testFrac1.equal(testFrac2))
	}
	...
	fun plusTest() {
		...
		assertEquals(expect, testFrac1.equal(result))
	}
	...
	fun toStringTest() {
		val testFrac1 = TFrac("1/2")
		val expect = "1/2"
		assertEquals(expect, testFrac1.toString())
	}
	...
	fun biggerThanTest() {
		...
		val testFrac2 = TFrac("3/4")
		val expect = true
		assertEquals(expect, testFrac2.biggerThan(testFrac1))
	}
	...
	fun equalTest() {
		...
		val testFrac2 = TFrac("3/4")
		val expect = true
		assertEquals(expect, testFrac2.equal(testFrac1))
	}
	...
	fun smallerThanTest() {
		...
		val testFrac2 = TFrac("3/4")
		val expect = true
		assertEquals(expect, testFrac1.smallerThan(testFrac2))
	}
	...
	fun getNumeratorIntTest() {
		val testFrac1 = TFrac("3/4")
		val expect = 3
		assertEquals(expect, testFrac1.getNumeratorInt())
	}
	...
	fun getNumeratorStringTest() {
		val testFrac1 = TFrac("3/4")
		val expect = "3"
		assertEquals(expect, testFrac1.getNumeratorString())
	}
	...
	fun getDenominatorIntTest() {
		val testFrac1 = TFrac("3/4")
		val expect = 4
		assertEquals(expect, testFrac1.getDenominatorInt())
	}
	...
	fun getDenominatorStringTest() {
		val testFrac1 = TFrac("3/4")
		val expect = "4"
		assertEquals(expect, testFrac1.getDenominatorString())
	}
}