...
class ComplexUnitTest {
	...
	fun initTest() {
		...
		val expect = true
		assertEquals(expect, testComplex1.equal(testComplex2))
	}
	...
	fun plusTest() {
		...
		assertEquals(expect, testComplex1.equal(result))
	}
	...
	fun toStringTest1() {
		...
		val expect = "3.0 + 8.0i"
		assertEquals(expect, testComplex1.toString())
	}
	...
	fun powTest() {
		...
		val delta = 0.01
		assertEquals(expectReal, testComplex1.getRealDouble(), delta)
		assertEquals(expectImagine, testComplex1.getImagineDouble(), delta)
	}
	...
	fun equalTest() {
		...
		val testComplex2 = Complex("2 + 2i")
		val expect = true
		assertEquals(expect, testComplex2.equal(testComplex1))
	}
	...
	fun notEqualTest() {
		...
		val expect = true
		assertEquals(expect, testComplex2.notEqual(testComplex1))
	}
	...
	fun getRealDouble() {
		...
		val expect = 2.0
		val delta = 0.01
		assertEquals(expect, testComplex1.getRealDouble(), delta)
	}
	...
	fun getImagineDouble() {
		...
		val expect = 4.0
		val delta = 0.01
		assertEquals(expect, testComplex1.getImagineDouble(), delta)
	}
	...
	fun getRealString() {
		val testComplex1 = Complex("2 + 2i")
		val expect = "2.0"
		assertEquals(expect, testComplex1.getRealString())
	}
	...
	fun getImagineString() {
		val testComplex1 = Complex("2 + 4i")
		val expect = "4.0"
		assertEquals(expect, testComplex1.getImagineString())
	}
}